    ...
    <div className="searchParam" onChange={onChange}>
        ...
        <label htmlFor="search-title"
            ...
            <input type="radio"
                   name="search"
                   id="search-title"
                   value={SEARCH_BY.TITLE.value}
                   defaultChecked={searchBy === SEARCH_BY.TITLE.value}/> {SEARCH_BY.TITLE.name}
        </label>
        <label htmlFor="search-genre"
            ...
            <input type="radio"
                   name="search"
                   id="search-genre"
                   value={SEARCH_BY.GENRE.value}
                   defaultChecked={searchBy === SEARCH_BY.GENRE.value}/> {SEARCH_BY.GENRE.name}
        </label>
